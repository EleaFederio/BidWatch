...
import KanbanAddProjectToBacklogModal from '@/components/kanban/KanbanAddProjectToBacklogModal';
...
export default function Kanban({ auth, contracts = [], board = null }) {
    ...
    return (
        ...
        >
                            ...
                            {columns.map((column) => (
                                ...
                                >
                                    ...
                                    <KanbanCard
                                        ...
                                        defaultCardLabelColor={defaultCardLabelColor}
                                        ...
                                        openCardCustomizationModal={openCardCustomizationModal}
                                        openCardDeleteConfirmModal={openCardDeleteConfirmModal}
                                    />
                                </section>
                            ))}
                        </div>
            ...
            <KanbanAddProjectToBacklogModal
