...
const ContractScheduleForm = () => {
    ...
    return (
        ...
        <label>Bidding Schedule</label>
        <div className="flex flex-col">
            <Datepicker selected={preBidSchedule} onChange={date=>setPreBidSchedule(date)} showTimeSelect />
        </div>

        <label>Contract Posting Schedule</label>
        <div date-rangepicker className="flex items-center w-full mb-20 ">
